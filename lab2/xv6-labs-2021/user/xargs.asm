...
int readline(char* new_argv[32], int curr_argc) {
  ...
  5e:	95e58593          	addi	a1,a1,-1698 # 9b8 <malloc+0xec>
  62:	4509                	li	a0,2
  64:	00000097          	auipc	ra,0x0
  68:	782080e7          	jalr	1922(ra) # 7e6 <fprintf>
			exit(1);
  6c:	4505                	li	a0,1
...
int main(int argc, char const* argv[])
{
 ...
 146:	78a080e7          	jalr	1930(ra) # 8cc <malloc>
 14a:	89aa                	mv	s3,a0
 ...
 180:	750080e7          	jalr	1872(ra) # 8cc <malloc>
 ...
 1d4:	80058593          	addi	a1,a1,-2048 # 9d0 <malloc+0x104>
 1d8:	4509                	li	a0,2
 1da:	00000097          	auipc	ra,0x0
 1de:	60c080e7          	jalr	1548(ra) # 7e6 <fprintf>
		exit(1);
 1e2:	4505                	li	a0,1
 ...
 1fe:	7f658593          	addi	a1,a1,2038 # 9f0 <malloc+0x124>
 202:	4509                	li	a0,2
 204:	00000097          	auipc	ra,0x0
 208:	5e2080e7          	jalr	1506(ra) # 7e6 <fprintf>
			exit(1);
 20c:	4505                	li	a0,1
...
putc(int fd, char c)
{
 ...
 550:	f5e080e7          	jalr	-162(ra) # 4aa <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 56e:	0805c963          	bltz	a1,600 <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
 ...
 582:	4e250513          	addi	a0,a0,1250 # a60 <digits>
 586:	883a                	mv	a6,a4
 ...
 5a6:	fec7f0e3          	bgeu	a5,a2,586 <printint+0x2a>
  if(neg)
 5aa:	00088c63          	beqz	a7,5c2 <printint+0x66>
    buf[i++] = '-';
 ...
 5be:	0028071b          	addiw	a4,a6,2
  ...
  while(--i >= 0)
 5c2:	02e05863          	blez	a4,5f2 <printint+0x96>
 ...
 5e8:	f56080e7          	jalr	-170(ra) # 53a <putc>
  while(--i >= 0)
 5ec:	197d                	addi	s2,s2,-1
 5ee:	ff3918e3          	bne	s2,s3,5de <printint+0x82>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 642:	3cac8c93          	addi	s9,s9,970 # a08 <malloc+0x13c>
 ...
 650:	414b8b93          	addi	s7,s7,1044 # a60 <digits>
 654:	a839                	j	672 <vprintf+0x6a>
        putc(fd, c);
 656:	85ca                	mv	a1,s2
 658:	8556                	mv	a0,s5
 65a:	00000097          	auipc	ra,0x0
 65e:	ee0080e7          	jalr	-288(ra) # 53a <putc>
 ...
 6b8:	ea8080e7          	jalr	-344(ra) # 55c <printint>
 6bc:	8b4a                	mv	s6,s2
      } else {
 ...
 6d4:	e8c080e7          	jalr	-372(ra) # 55c <printint>
 6d8:	8b4a                	mv	s6,s2
      state = 0;
 6da:	4981                	li	s3,0
 ...
 6f0:	e70080e7          	jalr	-400(ra) # 55c <printint>
 6f4:	8b4a                	mv	s6,s2
      state = 0;
 6f6:	4981                	li	s3,0
 ...
 710:	e2e080e7          	jalr	-466(ra) # 53a <putc>
  putc(fd, 'x');
 714:	07800593          	li	a1,120
 718:	8556                	mv	a0,s5
 71a:	00000097          	auipc	ra,0x0
 71e:	e20080e7          	jalr	-480(ra) # 53a <putc>
 722:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 734:	e0a080e7          	jalr	-502(ra) # 53a <putc>
 ...
 760:	dde080e7          	jalr	-546(ra) # 53a <putc>
          s++;
 ...
 776:	28e98993          	addi	s3,s3,654 # a00 <malloc+0x134>
        while(*s != 0){
 77a:	85ee                	mv	a1,s11
 ...
 78c:	db2080e7          	jalr	-590(ra) # 53a <putc>
 790:	8b4a                	mv	s6,s2
      state = 0;
 792:	4981                	li	s3,0
 ...
 79e:	da0080e7          	jalr	-608(ra) # 53a <putc>
      state = 0;
 7a2:	4981                	li	s3,0
 ...
 7ba:	d84080e7          	jalr	-636(ra) # 53a <putc>
      state = 0;
 7be:	4981                	li	s3,0
...
free(void *ap)
{
 ...
 858:	2247b783          	ld	a5,548(a5) # a78 <freep>
 ...
 880:	00e6ea63          	bltu	a3,a4,894 <free+0x4a>
{
 ...
 8c2:	1af73d23          	sd	a5,442(a4) # a78 <freep>
}
 8c6:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 8f4:	18853503          	ld	a0,392(a0) # a78 <freep>
 ...
 91c:	16090913          	addi	s2,s2,352 # a78 <freep>
  if(p == (char*)-1)
 920:	5afd                	li	s5,-1
 922:	a895                	j	996 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 924:	00000797          	auipc	a5,0x0
 928:	15c78793          	addi	a5,a5,348 # a80 <base>
 92c:	00000717          	auipc	a4,0x0
 930:	14f73623          	sd	a5,332(a4) # a78 <freep>
 934:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 958:	12a73223          	sd	a0,292(a4) # a78 <freep>
      return (void*)(p + 1);
 ...
 9a6:	b70080e7          	jalr	-1168(ra) # 512 <sbrk>
  if(p == (char*)-1)
